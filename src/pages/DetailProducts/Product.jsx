      ...
      <div className="main-wrapper flex flex-col md:flex-row md:px-[200px] md:py-[100px] relative">
        ...
        <div className="description p-6 md:basis-1/2 md:py-[40px]">
          ...
          <h1 className="text-3xl md:text-4xl capitalize font-[700]">
            LONOVO LEGION 
            <br /> <h6>Spesifikasi</h6>
          </h1>
          <p className="hidden md:block text-darkGrayishBlue my-10 leading-7">
            • Processor : Intel® Core™ i9-13980HX, 24C (8P + 16E) / 32T, P-core
            2.2 / 5.6GHz, E-core 1.6 / 4.0GHz, 36MB • Display : 16" 3.2K
            (3200x2000) Mini LED 1200nits Anti-glare, 100% DCI-P3, 100% Adobe®
            RGB, 100% sRGB • Memory : 2x 32GB SO-DIMM DDR5-5600 (Overclock)
          ...
          <div className="buttons-container flex flex-col md:flex-row mt-8">
            ...
            <button className="add-btn border-none bg-indigo-500 rounded-lg text-white font-[700] px-[70px] py-[18px] mt-4 md:mt-0 md:py-0 md:text-[14px] transition-all btn-shadow hover:opacity-50">
              <img
